...
const Auth = ({ setAuthPopup }) => {
  ...
  //Sign in or sign up form submission
  const handleFormSubmission = (e) => {
    //prevent interaction with map
    e.preventDefault();
    e.stopPropagation();
    //Sign in
    if (!signup) {
      console.log(`Signing in with email ${email}`);
      //sign in with backend and log/display errors if any
    ...
    //Sign up
      ...
      //signup with backend and log/display errors if any
